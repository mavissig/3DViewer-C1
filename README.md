...
В рамках Учебного проекта я написал программу, позволяющую просматривать 3D моделей в каркасном виде.

Во главе угла я ставил задачу разобраться как работают Аффинные преобразования, а так же попрактиковаться в работе с графикой.
...
В данном проекте я реализовал на языке программирования Си программу для просмотра 3D моделей в каркасном виде (3D Viewer). 
Сами модели можно загружать из файлов формата .obj и просматривать их на экране с возможностью вращения, масштабирования и перемещения.

Как дополнение я реализовал возможность записи скринкастов и сохранение настроек между сессиями.
...
- Программа разработана на языке Си стандарта C11 с использованием компилятора gcc. Для отображения интерфейса использовался QT
